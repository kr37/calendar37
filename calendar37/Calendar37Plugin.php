...
class Calendar37Plugin extends BasePlugin
{
	...
	public function onAfterInstall() {
		$settings['status'] = 'a';
		$settings['showTails'] = 'b';
		$settings['dateformat'] = 'c';
		$settings['dateformat1st'] = 'd';
		$settings['occurrenceFormat'] = 'e';
		$settings['availableTimes'] = 'f';
		$settings['mySetting'] = 'g';
		$settings['categoryFieldHandle'] = 'h';
		$settings['entryCalendarTextFieldHandle'] = 'i';
		$settings['cssFieldHandle'] = 'j';
		$settings['startDateFieldHandle'] = 'k';
		$success = craft()->plugins->savePluginSettings($this, $settings);
		if (!$success) die ("Failed to set initial settings. (But the plugin should be installed now)" );
	}
	...
	public function getDefaultSettings() {
		return array (
			...
			'categoryFieldHandle' => 'x',
			'entryCalendarTextFieldHandle' => 'x',
			'imageFieldHandle' => 'x',
			'cssFieldHandle' => 'x',
